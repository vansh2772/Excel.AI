...
export const exportChartAsPNG = async (chartElement: HTMLElement & { canvas?: HTMLCanvasElement }, title: string) => {
  if (!chartElement) {
...
export const exportChartAsPDF = async (chartElement: HTMLElement & { canvas?: HTMLCanvasElement }, title: string) => {
  if (!chartElement) {
    throw new Error('Chart element not found');
  }
