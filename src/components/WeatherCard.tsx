...
const WeatherCard: React.FC<WeatherCardProps> = ({ weatherData, loading, onRefresh }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-theme-accent2 backdrop-blur-md border border-theme-accent1 rounded-2xl p-6 transition-all duration-300 hover:bg-theme-accent1/50">
      ...
      {/* 5-Day Forecast */}
      <div className="bg-theme-accent2 backdrop-blur-md border border-theme-accent1 rounded-2xl p-6">
