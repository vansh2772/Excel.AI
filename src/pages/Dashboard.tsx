            ...
            {!hasData ? (
              <div className="space-y-8">
                <div className="text-center">
                  <h2 className="text-2xl font-bold text-theme-light mb-4">
                    Start Your AI-Powered Data Analysis
                  </h2>
                  <p className="text-lg text-theme-light/80 mb-8 max-w-2xl mx-auto">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h2 className="text-2xl font-bold text-theme-light">AI-Enhanced Data Analysis</h2>
                    <p className="text-theme-light/80">Analyzing: {datasetInfo.name} • Excel.AI Assistant Available</p>
                  </div>
                  <Button
                    variant="outline"
                    onClick={clearData}
